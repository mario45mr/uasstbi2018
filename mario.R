...
df<- read.csv("D:/stbi_maio/datasentimen_uji.csv", stringsAsFactors = FALSE)
glimpse(df)

df$class <- as.factor(df$class)
custom_stopwords <- read.csv("D:/stbi_mario/stopword.csv", header = FALSE)
...
dr<- read.csv("D:/stbi_mario/datasentimen_test.csv", stringsAsFactors = FALSE)
factor(dr$class)
